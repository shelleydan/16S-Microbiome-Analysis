...
```{r stat_plot, fig.width=10, fig.height=10}

df <- result1[[2]] %>%
  mutate(
    dd = suppressWarnings(as.numeric(dd))  # ensure numeric
  )
...
```{r plot_ordination, fig.align='center'}
ggplotly(ord_plot)
```
